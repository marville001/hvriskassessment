      ...
      {vdamage ? (
        <Container fluid className="si_container">
          ...
          <div
            ...
            style={{ display: airbagdeploys ? "block" : "none" }}
          >
            <div className="q_container">
              <div className="q_text">
          ...
          <div className="item_container">
            <div className="q_container">
              <div className="q_text">
                <div className="ask">*</div>Was the vehicle submerged or exposed
                to high volumes of water <span>?</span>
              </div>
              <div className="q_buttons">
                <Button
                  disabled={
          ...
          <div
            className="item_container"
            style={{ display: submerged ? "block" : "none" }}
          >
            <div className="q_container">
              <div className="q_text">
              ...
              <div className="q_buttons">
                <Button
                  disabled={
                    bareaflooded === null ? false : bareaflooded ? true : false
                  }
                  style={{
                    backgroundColor:
                      bareaflooded === null
          ...
          <div className="q_container">
            <div className="q_text">
              <div className="ask">*</div>Was the vehicle on fire or is there
              any evidence of fire damage <span>?</span>
            </div>
            <div className="q_buttons">
              <Button
                disabled={onfire === null ? false : onfire ? true : false}
                style={{
                  backgroundColor:
          ...
          <div
            className="item_container"
            style={{ display: onfire ? "block" : "none" }}
          >
            <div className="q_container">
              <div className="q_text">
